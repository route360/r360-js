function colorRouteExample(){
    ...
    r360.RouteService.getRoutes(travelOptions, function(routes){
        ...
        r360.LeafletUtil.fadeIn(routeLayer, routes[0], 1000, "travelDistance", { 
            color               : '#FF0600',
        ...
        r360.LeafletUtil.fadeIn(routeLayer, routes[1], 1000, "travelDistance", 
            { color : '#156ab8', haloColor : 'white', paintTransfer : true });
        // no fade in and no markers inbetween segments
        r360.LeafletUtil.fadeIn(routeLayer, routes[2], 0,    "travelDistance", 
    ...
    r360.RouteService.getRoutes(travelOptions, function(routes){
        ...
        r360.LeafletUtil.fadeIn(routeLayer, routes[0], 1000, "travelDistance", psychoOptions);
    });
}