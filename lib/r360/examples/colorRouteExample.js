function colorRouteExample(){
    ...
    r360.RouteService.getRoutes(travelOptions, function(routes){
        ...
        routes[0].fadeIn(routeLayer, 1000, "travelDistance", { color : '#ff0000', haloColor : 'white', paintTransfers : true });
        routes[1].fadeIn(routeLayer, 1000, "travelDistance", { color : '#156ab8', haloColor : 'white', paintTransfers : true });
    });
}