/*
 Route360° JavaScript API v0.3.1 (0a3f15f), a JS library for leaflet maps. http://route360.net
...
r360.PointOfInterestService = {
    ...
    getCfg : function(travelOptions) {
        ...
        var cfg = {
            ...
            serviceUrl       : travelOptions.getServiceUrl()
        };
        ...
        return {
            "cfg": cfg,
            "query"  : travelOptions.getPoiQuery(),
            "format" : travelOptions.getPoiQueryFormat(),
        };
    },

    getRouteTime : function(travelOptions, successCallback, errorCallback) {

        var cfg = r360.PointOfInterestService.getCfg(travelOptions);

        if ( !r360.has(r360.PointOfInterestService.cache, JSON.stringify(cfg)) ) {

            // execute routing time service and call callback with results
            r360.RequestUtil.request({
                url:         travelOptions.getPoiServiceUrl() + '/traveltime?key=' +travelOptions.getServiceKey(),
                type:        "POST",
                ...
                success: function (result) {
                    ...
                    if ( r360.has(result, 'data')  ) {
                        ...
                        if ( result.code == 'ok' ) {
                            ...
                            // cache the result
                            r360.PointOfInterestService.cache[JSON.stringify(cfg)] = result.data;
                    ...
                    // fallback for old clients
                        ...
                        // cache the result
                        r360.PointOfInterestService.cache[JSON.stringify(cfg)] = result;
                        // call successCallback with returned results
            ...
            successCallback(r360.PointOfInterestService.cache[JSON.stringify(cfg)]);
        }
    }
};
