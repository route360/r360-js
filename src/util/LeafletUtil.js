...
r360.LeafletUtil = {
    ...
    fadeIn : function(map, drawingTime, fadingType, options, onClick){
        ...
        function addCircularMarker(latLng, segment, options) {
            var marker = r360.circleMarker(latLng, { 
        ...
        function fader(segment, millis, options, z){
            ...
            var haloLine    = r360.polyline(choppedLine[0], polylineHaloOptions).addTo(map);
            var polyLine    = r360.polyline(choppedLine[0], polylineOptions).addTo(map);
