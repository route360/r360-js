$(document).ready(function(){
    ...
    r360.config.defaultTravelTimeControlOptions.travelTimes = [
        { time : 1200 * 1 , color : "#006837", opacity : 1.0 },
        { time : 1200 * 2 , color : "#39B54A", opacity : 1.0 },
        { time : 1200 * 3 , color : "#8CC63F", opacity : 1.0 },
        { time : 1200 * 4 , color : "#F7931E", opacity : 1.0 },
        { time : 1200 * 5 , color : "#F15A24", opacity : 1.0 },
        { time : 1200 * 6 , color : "#C1272D", opacity : 1.0 }
    ];
